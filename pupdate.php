...
<tr>
<td>Name</td>
<td><input type="text"  class="form-control" name="name" value="<?php echo $row['name'];?>" style="margin-left:10px;"></td>
</tr>
<tr>
<td>F'Name</td>
<td><input type="text" class="form-control" name="fname" value="<?php echo $row['fname'];?>" style="margin-top:10px;margin-left:10px;"/></td>
</tr>
<tr>
<td>Gender</td>
<td>
...
<tr>
<td>Age</td>
<td><input type="number" class="form-control" name="age" value="<?php echo $row['age'];?>" style="margin-top:10px;margin-left:10px;"/></td>
</tr>
<tr>
<td>Address</td>
...
<br/>
<input type="submit" class="btn btn-default" value="Update" style="margin-top:10px;"/>
</form>
<?php
}
?>
