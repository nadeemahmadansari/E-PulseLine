...
<div class="row" style="min-height:auto;margin-top:82px;">

</div>
<div class="row" style="min-height:400px;background-color:#1de9b6;">
<br/>
...
<td><a href="valdoccode.php?id=<?php echo $row['docid'];?>"><input type="button" class="btn btn-default" value="Cancel"/></a></td>
</tr>
<?php
	$a++;
}	
