...
{
?>
<p style="font-size:20px;margin-top:10px;margin-left:300px;"><?php echo "Welcome ".$row['name'];?></p>
<?php
}
?>
</div>
...
<div class="row" style="min-height:400px;margin-top:155px;">
...
<h1 style="font-family:calibri;">Your Feedback</h1>
<textarea name="feed" class="form-control" style="height:150px;"></textarea>
<br/>
