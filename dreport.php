...
<p style="font-size:20px;margin-top:10px;margin-left:200px;"><?php echo "Welcome ".$name;?></p>
</div>
</div>
...
<div class="row" style="min-height:auto;background-color:#a7ffeb;margin-top:170px;">
...
<?php
$a=1;
$query1="select * from tbl_report where docid='$docid'";
...
?>
	...
	<td><form action="dremark.php" method="post">
	<input type="hidden" name="repid" value="<?php echo $row1['repid'];?>"/>
