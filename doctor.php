...
<center>
<div class="row" style="min-height:600px;;width:500px;margin-top:50px;background-color:#a7ffeb;box-shadow:2px 2px 5px black;">
<form class="form-inline" action="doccode.php" method="post"  enctype="multipart/form-data"/>
...
<tr>
<td>Gender</td>
<td><input type="radio" name="a" value="Male" required style="margin-left:10px;margin-top:10px;"/>Male
...
<tr>
<td>Mobile</td>
<td><input type="number" class="form-control" name="mobile" placeholder="Mobile Number" required style="width:275px;margin-left:10px;margin-top:10px;"/></td>
</tr>
<tr>
<td>Fees</td>
<td><input type="number" class="form-control" name="fees" placeholder="Fess" required style="width:275px;margin-left:10px;margin-top:10px;"/></td>
</tr>
<tr>
<td>Speciality</td>
<td>
<select name="spcl" class="form-control" required style="width:275px;margin-left:10px;margin-top:10px;">
<option value="">--Select Speciality--</option>
<option>Physician</option>
<option>Opthomologist</option>
<option>Orthopedic</option>
<option>Neuorlogist</option>
...
<tr>
<td>Timing</td>
<td><input type="text" class="form-control" name="timing" placeholder="Doctor Timing" required style="width:275px;margin-left:10px;margin-top:10px;"/></td>
</tr>
<tr>
<td>Upload Pic</td>
<td><input type="file" name="file" style="width:275px;margin-left:10px;margin-top:10px;"/></td>
</tr>
</table>
<br/>
...
<img src="images/doc.jpg" height="600px;" width="100%"/>
</div>
</center>
</div>
</div>
