	...
	<ul class="navbar-right" style="margin-right:5px;margin-top:5px;">
	  ...
	  <?php
		if($row=mysql_fetch_array($res,MYSQL_BOTH))
			{
		?>
				 <h4 style="margin-top:40px;"><?php echo "Welcome ".$row['name'];?></h4>
		<?php
			}
		?>
      </ul>
...
<div class="row" style="min-height:740px;margin-top:150px;">
<div class="col-sm-3" style="min-height:350px;">
<div class="hovereffect">
        <img class="img-responsive" src="images/home.jpg" alt="" height="300px;" style="margin-top:55px;margin-left:50px;"/>
        <div class="overlay">
        <a class="info" href="pprofile.php">Home</a>
    </div>
</div>
</div>
<div class="col-sm-3" style="min-height:350px;">
<div class="hovereffect">
        <img class="img-responsive" src="images/bookappoint.jpg" alt="" height="300px;" width="100%" style="margin-top:50px;"/>
        <div class="overlay">
        <a class="info" href="pbook.php">Book Appointment</a>
    </div>
</div>
</div>
<div class="col-sm-3" style="min-height:350px;">
<div class="hovereffect">
        <img class="img-responsive" src="images/myappoint.jpg" alt="" height="300px;" width="100%" style="margin-top:50px;"/>
        <div class="overlay">
        <a class="info" href="pmyappointment.php">My Appointment</a>
    </div>
</div>
</div>
<div class="col-sm-3" style="min-height:350px;">
<div class="hovereffect">
        <img class="img-responsive" src="images/update.png" alt="" height="300px;" style="margin-top:50px;margin-left:70px;"/>
        <div class="overlay">
        <a class="info" href="pupdate.php">Update Profile</a>
    </div>
</div>
</div>
<div class="col-sm-3" style="min-height:350px;margin-left:125px;margin-top:20px;margin-right:50px;">
<div class="hovereffect">
        <img class="img-responsive" src="images/change1.jpg" alt="" height="300px;" width="100%" style="margin-top:20px;"/>
        <div class="overlay">
        <a class="info" href="pchange.php">Change Password</a>
    </div>
</div>
</div>
<div class="col-sm-3" style="min-height:350px;margin-top:20px;margin-right:50px;">
<div class="hovereffect">
        <img class="img-responsive" src="images/feedback.jpg" alt="" height="300px;" width="100%" style="margin-top:50px;"/>
        <div class="overlay">
        <a class="info" href="pfeedback.php">Feedback</a>
    </div>
</div>
</div>
<div class="col-sm-3" style="min-height:350px;margin-top:20px;margin-right:50px;">
<div class="hovereffect">
        <img class="img-responsive" src="images/discussion.png" alt="" height="300px;" width="100%" style="margin-top:50px;"/>
        <div class="overlay">
        <a class="info" href="pdiscuss.php">Discussion Board</a>
    </div>
</div>
</div>
</div>
