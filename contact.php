...
<div class="row" style="min-height:450px;margin-top:150px;">
<div class="col-sm-5" style="min-height:450px;">
<center>
<div class="row" style="height:350px;width:500px;margin-top:50px;background-color:#a7ffeb;box-shadow:2px 2px 5px black;">
<form action="contactcode.php" method="post">
<h1>Contact Us</h1>
<table>
<tr>
<td>Name</td>
<td><input type="text"  class="form-control" name="name" placeholder="Name" style="width:275px;margin-left:10px;margin-top:10px;"/></td>
</tr>
<tr>
<td>Email</td>
<td><input type="email" class="form-control" name="email" placeholder="Email" style="width:275px;margin-left:10px;margin-top:10px;"/></td>
</tr>
<tr>
<td>Mobile</td>
<td><input type="number" class="form-control" name="mobile" placeholder="Mobile" style="width:275px;margin-left:10px;margin-top:10px;"/></td>
</tr>
<td>Message
<td><textarea name="msg" class="form-control" placeholder="Message" style="width:275px;margin-left:10px;margin-top:10px;"></textarea></td>
</tr>
</table>
<br/>
...
<div class="row" style="min-height:350px;width:600px;margin-top:50px;margin-left:100px;background-color:#a7ffeb;box-shadow:2px 2px 5px black;">
<div class="row" style="min-height:">
<center><h1 style="font-size:50px;">Address</h1></center>
</div>
<br/>
<p style="font-size:50px;margin-left:60px;font-family:calibri;">3/24 Sector J, Kursi Road, Aliganj, Lucknow.</p>
</div>
</div>
</div>
<div class="row" style="min-height:400px;border:1px solid;">
</div>
