...
<a href="adminlogout.php"><input type="button" class="btn btn-default navbar-right" value="Logout" style="margin-top:15px;margin-right:50px;"/></a>
<p style="font-size:25px;margin-top:15px;">Welcome Admin</p>
</div>
<div class="row" style="min-height:400px;;margin-top:22px;background-color:#a7ffeb;">
