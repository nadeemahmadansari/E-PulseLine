...
$query2="select name from tbl_patient where email='$email'";
...
{
?>
<p style="font-size:20px;margin-top:10px;margin-left:300px;"><?php echo "Welcome ".$row2['name'];?></p>
<?php
}
?>
</div>
...
<div class="col-sm-4" style="min-height:auto;margin-top:20px;">
</div>
<center>
<div class="col-sm-4" style="min-height:auto;margin-top:20px;background-color:#a7ffeb;">
<form action="pbook.php" method="post">
<h3>Choose Speciality</h3>
<select name="spcl" class="form-control" style="width:200px;">
...
<select>
<br/>
<center><input type="submit" class="btn btn-default" value="Send" style="width:70px;"/></center>
</form>
</div>
</center>
<div class="col-sm-4" style="min-height:auto;margin-top:20px;">
